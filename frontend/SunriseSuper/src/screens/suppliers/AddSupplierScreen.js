...
export default function AddSupplierScreen({ navigation }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await axios.post(`${BASE_URL}/suppliers`, formData, {
    ...
    >
      ...
      <TouchableOpacity style={styles.docPicker} onPress={pickDocument}>
        {document ? (
          ...
          <View style={styles.docPickerPlaceholder}>
            ...
            <Text style={styles.docPickerText}>Tap to select contract file (PDF, etc.)</Text>
          </View>
        )}
      </TouchableOpacity>
      {document && (
      ...
      >
        {loading
          ...
          : <Text style={styles.submitBtnText}>Create Supplier</Text>
        }
      </TouchableOpacity>
